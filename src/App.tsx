                    ...
                    <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-hide">
                      {CATEGORIES.map(cat => (
                        <button
                          ...
                          className={`px-4 py-2 rounded-lg text-[10px] font-black uppercase tracking-wider transition-all border ${activeCategory === cat
            ...
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900">
              ...
              >
                <div className="p-8 pb-4 text-center">
                  <div className="w-20 h-20 bg-white rounded-2xl flex items-center justify-center mx-auto shadow-xl mb-6 overflow-hidden border border-slate-100">
                    <img src={logo} alt="Witbank Express Logo" className="w-full h-full object-cover" />
                  </div>
